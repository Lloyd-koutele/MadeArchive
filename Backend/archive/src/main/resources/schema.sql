...
ALTER TABLE journal_audit ADD CONSTRAINT journal_audit_action_check CHECK (action::text = ANY (ARRAY[
    ...
    'PROJET_CREE','PROJET_MODIFIE','PROJET_TYPES_AJOUTES','PROJET_TYPE_RETIRE','PROJET_SUPPRIME','PROJET_ACCES_MODIFIE',
    ...
    'DOCUMENT_EMPLACEMENT_MODIFIE','DOCUMENT_METADATA_MODIFIEE','DOCUMENT_PROJET_MODIFIE','DOCUMENT_ACCES_MODIFIE',
